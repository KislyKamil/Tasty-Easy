<?php
/* Smarty version 3.1.33, created on 2019-04-29 22:19:29
  from 'D:\Xampp\htdocs\Tasty&Easy\app\views\appView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.33',
  'unifunc' => 'content_5cc75c514c7f83_30422652',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3a58b9d2d649d1627fe321c067a72f88c68c124e' => 
    array (
...
function content_5cc75c514c7f83_30422652 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
...
/css/skills/progressbar.css">
        <link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
/css/skills/style1.css">
        <link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
                            ...
                            <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-target="#quote-carousel" data-slide-to="0" class="active">
                                        <img class="img-responsive " src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-xs-12">
                            <div class="copyright_text">
                                <p class=" wow fadeInRight" data-wow-duration="1s">Made with <i class="fa fa-heart"></i> by <a href="http://bootstrapthemes.com">Bootstrap Themes</a>2016. All Rights Reserved</p>
                            </div>
                        </div>
...
>
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
/js/portfolio.jquery.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
/js/jquery.mixitup.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
...
>
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
/css/skills/inview.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
/css/skills/progressbar.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
/css/skills/main.js"><?php echo '</script'; ?>
>
        <!--This is link only for gmaps-->
        <?php echo '<script'; ?>
 src="http://maps.google.com/maps/api/js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
 src="<?php echo $_smarty_tpl->tpl_vars['conf']->value->app_url;?>
/js/gmaps.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
>
            var map = new GMaps({
